...
class _STIXBase(Mapping):
    ...
    def __init__(self, allow_custom=False, **kwargs):
        ...
        extra_kwargs = six.viewkeys(kwargs) - six.viewkeys(self._properties)
        ...
        all_custom_prop_names = extra_kwargs | six.viewkeys(custom_props) - \
            six.viewkeys(self._properties)
