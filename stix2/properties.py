...
class ReferenceProperty(Property):
    ...
    def clean(self, value, allow_custom):
        ...
        if self.valid_types:
            ...
            ref_valid_types = enumerate_types(self.valid_types, self.stix_vid)
            ...
            ref_invalid_types = enumerate_types(self.invalid_types, self.stix_vid)
            ...
            # prefix, for now?
            type_maps = STIX2_OBJ_MAPS[self.stix_vid]
